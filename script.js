...
const perguntas = [
  ...
  {
    enunciado:
      "No debate sobre IA e o futuro do trabalho, como você se posiciona?",
    alternativas: [
      {
        texto: "Defende que a IA cria novas oportunidades de emprego.",
        afirmacao:
          "Vem impulsionando a inovação e criando novos caminhos profissionais com IA. ",
      },
      {
  ...
  {
    enunciado:
      "Você precisa criar uma imagem que represente sua visão sobre a IA. E agora?",
    alternativas: [
      {
        texto: "Criar com Paint ou outra ferramenta de design tradicional.",
        afirmacao:
          "Decidiu compartilhar conhecimentos em design com ferramentas digitais. ",
      },
      {
        texto: "Criar com gerador de imagens por IA.",
        afirmacao:
          "Agora ensina pessoas a usarem IA para expressar ideias visualmente. ",
      },
    ],
  },
  {
    enunciado:
      "Seu grupo atrasou o trabalho de biologia, e alguém colou tudo do chat. O que faz?",
    alternativas: [
      {
